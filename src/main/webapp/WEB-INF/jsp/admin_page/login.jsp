...
<title>登录页面 - 后台管理</title>

<meta name="description" content="后台管理用户登录页面" />
<meta name="viewport"
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														name="username" defaultValue="<shiro:principal/>"
													...
													class="block input-icon input-icon-right"> <input
														...
														placeholder="Password" onfocus="this.type='password'"
														autocomplete="off" /> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														name="rememberMe" class="ace" /> <span class="lbl">记住我</span>
													</label>
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header red lighter bigger">
											<i class="ace-icon fa fa-key"></i>取回密码
										</h4>
										...
										<form>
											<fieldset>
												<label class="block clearfix"> <span
													...
													class="ace" /> <span class="lbl">我接受<a href="#">用户条款</a>
												</span>
												</label>
