...
<body class="no-skin">
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<a href="http://www.hy-software.com/" target="_blank">南通恒优信息科技有限公司</a>
	...
	<!-- gijianfeng 2015-12-20 add 根据后台返回的全局量，401值进行页面的跳转，此处用于超时跳转到登陆页 -->
	<script>
    $.ajaxSetup({
      complete : function(XMLHttpRequest, textStatus){
        if ("401" == XMLHttpRequest.status) {
          alert("您已经30分钟没有进行操作，请重新登陆，确保安全！");
